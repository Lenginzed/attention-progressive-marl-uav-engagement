...
class PPOPolicy:
    def __init__(self, args, obs_space, cent_obs_space, act_space, device=torch.device("cpu")):
        ...
        self.critic = PPOCritic(args, self.cent_obs_space, self.obs_space, self.device)
    ...
    def copy(self):
        return PPOPolicy(self.args, self.obs_space, self.cent_obs_space, self.act_space, self.device)

    def set_progress(self, progress: float):
        self.actor.set_progress(progress)
