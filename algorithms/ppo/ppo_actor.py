...
class PPOActor(nn.Module):
    def __init__(self, args, obs_space, act_space, device=torch.device("cpu")):
        ...
        self.act = ACTLayer(
            ...
            self.gain,
            progressive_cfg={
                "enabled": args.use_progressive_action_discretization,
                "strides": args.progressive_action_strides,
                "boundaries": args.progressive_stage_boundaries,
            },
        )
    ...
    def set_progress(self, progress: float):
        self.act.set_progress(progress)
