...
from runner.share_offpolicy_jsbsim_runner import ShareOffPolicyJSBSimRunner
...
from envs.JSBSim.utils.utils import resolve_jsbsim_data_dir
...
def main(args):
    ...
    data_dir = resolve_jsbsim_data_dir()
    logging.info(f"Using JSBSim data dir: {data_dir}")
    ...
    # run experiments
    if all_args.env_name == "MultipleCombat":
        if all_args.algorithm_name == "matd3":
            runner = ShareOffPolicyJSBSimRunner(config)
        else:
